...
import { Package, ChefHat, Factory, LayoutDashboard, LogOut, Clock, FileText, ShoppingCart, Truck, ArrowRightLeft, Users, Menu, X, KeyRound, Loader2, Save, Lock, Eye, EyeOff, FlaskConical, Wallet, Sun, History } from 'lucide-react';
...
export function Layout() {
  ...
  const navItems = [
    ...
    { name: 'Currículos Recebidos', path: '/rh/candidaturas', icon: FileText, roles: ['Admin', 'Gestor'] },
    ...
    { name: 'Auditoria do Sistema', path: '/auditoria', icon: History, roles: ['Admin', 'Gestor'] },
